...
public class UIPublish {
	...
	@FindAll(@FindBy(how = How.XPATH, using = "//*[@id='schMsgFORM']//td[3]//div[starts-with(@class,'message-wrap')]"))
	public List <WebElement> listOfTextInMessagesSocial;	
	
	//*[@id='inbox-wrapper']//td[3]/div[1]
	//*[@id='email-list']//td[3]//div[starts-with(@class,'message-wrap')]//br
