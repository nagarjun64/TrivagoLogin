...
public class UIReports {

	public UIReports (WebDriver driver) {
	...
	//YouTube EMail button
	@FindBy(id = "Email")
	public WebElement youTubeEmail;

	//Next button in login screen
	@FindBy(id = "next")
	public WebElement nextYT;
	...
	@FindBy(id = "signIn")
	public WebElement youTubeSignIn;

	//Galloway360 YouTube Channel
	@FindBy(xpath = "//*[@id='account-']//span[text()='galloway360']")
	public WebElement ytChannelGalloway360;

	//Galloway360 YouTube Channel
	@FindBy(xpath = "//*[@id='signin-action']")
	public WebElement ytSelectAnAccount;

	//YouTube Channels List
	@FindAll(@FindBy(how = How.XPATH, using = "//*[@id='account-']//span[@class='account-name']"))
	public List<WebElement> youTubeChannelsList;

	//Galloway360 YouTube Channel
	@FindBy(xpath = "//*[@id='submit_approve_access']")
	public WebElement allowYouTubeChannel;
