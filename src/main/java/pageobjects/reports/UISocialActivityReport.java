...
public class UISocialActivityReport {

	public UISocialActivityReport (WebDriver driver) {
	...
	@FindBy(linkText = "Social Activity Report")
	public WebElement socialActivityReportTitle;
	...
	public WebElement statusListfirstStatus;

	//Second status in the status filter
	@FindBy(xpath = "//select[@id='msgPropType']//option[3]") 
	public WebElement statusListSecondStatus;
