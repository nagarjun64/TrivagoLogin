...
public class UILoginReport {

	public UILoginReport (WebDriver driver) {
	...
	@FindBy(xpath = "//li[@class='pagination-arrow ' and starts-with(@onclick, 'nextLoginRpt')]//i")  	//li[@class='pagination-arrow ' and contains(@title, 'Go to next page')]//i
	public WebElement gotoNextPg;

	//Navigate to Previous Page in Competitor Pages
	@FindBy(xpath = "//li[@class='pagination-arrow' and contains(@onclick, 'previousLoginRpt')]//i")   //li[@class='pagination-arrow' and contains(@title, 'Go to previous page')]//i
	...
	@FindBy(xpath = "//button[@onclick='javascript:loadLoginRpt(this);' and text()[contains(.,'Filter')]]")
